...
/**
 * ArrayMultimap is a Multimap backed with an associative array of key and array of 
 * value pairs. 
 *
...
class ArrayMultimap implements Multimap  
{
	...
	public function containsValue($value) {
		foreach ($this->map as $k => $v) {
			if (in_array($value, $v)) return true;
		}
		return false;
	}
	 ...
	 *
	 * @returns true if all the specified key value pairs are put in the 
	 * multimap.
	 */	
	 ...
	 *
	 * @returns true if the specified key value pair is removed from the 
	 * multimap.
	 */	
